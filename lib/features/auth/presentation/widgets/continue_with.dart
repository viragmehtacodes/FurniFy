...
import 'package:flutter_ecommerce_app/features/auth/data/services/firebase/auth_service.dart';
import 'package:flutter_ecommerce_app/constants/dimensions.dart';
import 'package:flutter_ecommerce_app/features/widgets/failure_snack_bar.dart';
...
class ContinueWithOtherAccounts extends StatelessWidget {
  const ContinueWithOtherAccounts({Key? key, required this.isLogin});
